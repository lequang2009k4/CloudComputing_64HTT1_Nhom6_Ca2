...
<body>
   <div class="container">
      <h3 class="text-center text-uppercase text-success mt-3 mb-3">Cập nhật thông tin bệnh nhân</h3>
      ...
      <button type="submit" class="btn btn-primary" name="btn_update" onclick="return confirm('Bạn có chắc chắn muốn cập nhật thông tin bệnh nhân này không?')">Cập nhật</button>
