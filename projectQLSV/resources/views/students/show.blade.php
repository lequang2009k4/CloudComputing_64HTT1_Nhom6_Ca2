...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-3">
            <label clas="col-sm-2 col-label-form"><b>Tên sinh viên</b></label>
            <div class="col-sm-10">
                {{ $student->StudentName }}
            </div>
        </div>
        <div class="row mb-3">
            <label clas="col-sm-2 col-label-form"><b>Địa chỉ Email</b></label>
            <div class="col-sm-10">
                {{ $student->StudentEmail }}
            </div>
        </div>
        <div class="row mb-4">
            <label clas="col-sm-2 col-label-form"><b>Giới tính</b></label>
            <div class="col-sm-10">
